...
namespace HalojenBackups {
	internal class Utilities {
		public static readonly List<string> reliableFileTypes = new List<string>() { "jpg", "jpeg", "mp4", "avi", "mp3" };
		...
		internal static bool FilesAreEqual(FileInfo fileInfo1, FileInfo fileInfo2) {
			...
			if (CompareFileSizes(fileInfo1, fileInfo2)) {
				...
				if (reliableFileTypes.Contains(fileInfo1.Extension.ToLower().Replace(".", String.Empty))) {
					return true;
				}
